...
// esptool.exe --chip esp32 merge_bin -o evil-portal-stickcplus.bin --flash_mode dio --flash_size 4MB 0x1000 .\evil-portal.ino.bootloader.bin 0x8000 .\evil-portal.ino.partitions.bin 0x10000 .\evil-portal.ino.bin
// esptool.exe --chip esp32 merge_bin -o evil-portal-cardputer.bin  --flash_mode dio --flash_size 8MB 0x0000 .\evil-portal.ino.bootloader.bin 0x8000 .\evil-portal.ino.partitions.bin 0x10000 .\evil-portal.ino.bin
